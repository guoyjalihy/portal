...
insert into menu (image, level, name, parent, status, url,id) values (null, 0, 'root', null, 1, null,0);
...
insert into menu (image, level, name, parent, status, url) values (null, 2, '权限管理', (select id from menu where name= '系统设置'),1,  '/privilege/list');
